...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            AddHandler Me.btnBegin.Click, New System.EventHandler(AddressOf Me.btnBegin_Click)
            ' 
            ' groupBox1
            ' 
            ...
            Me.label3.Text = "Try transposing the pivot grid with and without locking it, to see the difference" & " in performance."
            ' 
            ' Form1
            ' 
...
#End Region
        ...
        Private btnBegin As DevExpress.XtraEditors.SimpleButton
